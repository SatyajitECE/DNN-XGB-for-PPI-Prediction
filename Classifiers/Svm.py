...
SVM_fpr=pd.DataFrame(SVM_fpr)
SVM_tpr=pd.DataFrame(SVM_tpr)

SVM_fpr.to_csv('fpr_SVM.csv',header=False, index=False)
SVM_tpr.to_csv('tpr_SVM.csv',header=False, index=False)   
