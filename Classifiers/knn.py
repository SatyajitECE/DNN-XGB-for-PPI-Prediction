...
KNN_fpr=pd.DataFrame(KNN_fpr)
KNN_tpr=pd.DataFrame(KNN_tpr)

KNN_fpr.to_csv('fpr_KNN.csv',header=False, index=False)
KNN_tpr.to_csv('tpr_KNN.csv',header=False, index=False)   
